...
<Story name='Chart.Bar'>
    {React.createElement(() => {
        ...
        const lineStrokeDasharray = text('strokeDasharray', '1 0', lineId);
...
<Story name='Chart.Line'>
    {React.createElement(() => {
        ...
        const lineWidth = number('dotSettings: { width }', 18, {}, lineId);
        const lineInheritStroke = boolean('inheritStroke', true, lineId);
        const lineStrokeDasharray = text('strokeDasharray', '10 10', lineId);
        const lineDot = boolean('dot', true, lineId);
        ...
        const areaStrokeDasharray = text('strokeDasharray', '10 10', areaId);
