...
<Container>
    <Row>
        <Col>
            <Button rightAddons={<InformationCircleLineSIcon/>} view="primary" size="xxs">
                Кнопка
            </Button>
        </Col>
        <Col>
        ...
        <Col>
            <Button rightAddons={<InformationCircleLineSIcon/>} view="primary" size="s">
                Кнопка
            </Button>
        </Col>
        <Col>
            <Button rightAddons={<InformationCircleLineSIcon/>} view="primary" size="m">
                Кнопка
            </Button>
        </Col>
         <Col>
            <Button rightAddons={<InformationCircleLineSIcon/>} view="primary" size="l">
                Кнопка
            </Button>
        </Col>
        <Col>
            <Button rightAddons={<InformationCircleLineSIcon/>} view="primary" size="xl">
                Кнопка
            </Button>
        </Col>
    </Row>
