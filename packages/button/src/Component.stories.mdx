...
<div style={{border: '1px solid #e5e5e5', borderRadius: '4px', overflow: 'hidden'}}>
    ...
    <div data-theme='site' style={{padding: '24px', backgroundColor: '#0b1f35'}}>
        <Container>
            <Row align='middle'>
                <Col>
                    <Button inverted={true} view='primary'>Primary</Button>
                </Col>
                <Col>
                    <Button inverted={true} view='secondary'>Secondary</Button>
                </Col>
                <Col>
                    <Button inverted={true} view='outlined'>Outlined</Button>
                </Col>
            </Row>
        </Container>
    </div>
