...
<Story name='Confirmation'>
    {React.createElement(() => {
        ...
        const [noAttemptsLeftMessage, setNoAttemptsLeftMessage] = useState('');
        ...
        return (
            <div>
                ...
                <div style={{display: 'flex'}}>
                    ...
                    {variant.key === 'attempts-left' &&
                        <div style={{display: 'flex', width: '100%', maxWidth: '375px', padding: '15px', boxSizing: 'border-box'}}>
                            <Confirmation
                                phone={phone}
                                onInputFinished={() => handleSubmit('attempts-left')}
                                onSmsRetryClick={() => handleSmsRetryClick('attempts-left')}
                                codeSending={codeSending['attempts-left']}
                                codeChecking={codeChecking['attempts-left']}
                                error={!!error['attempts-left']}
                                errorText={error['attempts-left']}
                                errorIsFatal={true}
                                countdownDuration={countdownDuration}
                                code={value['attempts-left']}
                                onInputChange={({ code }) => setCode('attempts-left', code)}
                                alignContent={alignContent}
                                requiredCharAmount={requiredCharAmount}
