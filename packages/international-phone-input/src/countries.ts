// TODO: перенести это в @alfalab/data
...
const defaultCountriesData: CountryData[] = [
    ...
    ['British Indian Ocean Territory', 'Брит. Терр. в Индийском Океане', 'io', '246'],
    ...
    ['Caribbean Netherlands', 'Карибские Нидерланды', 'bq', '599', 1],
    ['Cayman Islands', 'Каймановы Острова', 'ky', '1345'],
    ['Central African Republic', 'ЦАР', 'cf', '236'],
    ['Chad', 'Чад', 'td', '235'],
    ['Chile', 'Чили', 'cl', '56'],
    ['China', 'Китайская Народная Республика', 'cn', '86'],
    ['Christmas Island (Australia)', 'Остров Рождества', 'cx', '61', 2],
    ['Cocos (Keeling) Islands', 'Кокосовые Острова', 'cc', '61', 1],
    ['Colombia', 'Колумбия', 'co', '57'],
    ['Comoros', 'Коморские Острова', 'km', '269'],
    ['Congo (DRC)', 'Демократическая Республика Конго', 'cd', '243'],
    ['Congo (Republic)', 'Республика Конго', 'cg', '242'],
    ['Cook Islands', 'Острова Кука', 'ck', '682'],
    ['Costa Rica', 'Коста-Рика', 'cr', '506'],
    ['Côte d’Ivoire', 'Кот-д’Ивуар', 'ci', '225'],
    ['Croatia', 'Хорватия', 'hr', '385'],
    ['Cuba', 'Куба', 'cu', '53'],
    ['Curaçao', 'Кюрасао', 'cw', '599', 0],
    ['Cyprus', 'Кипр', 'cy', '357'],
    ['Czech Republic', 'Чехия', 'cz', '420'],
    ['Denmark', 'Дания', 'dk', '45'],
    ['Djibouti', 'Джибути', 'dj', '253'],
    ['Dominica', 'Доминика', 'dm', '1767'],
    ['Dominican Republic', 'Доминиканская Республика', 'do', '1', 2, ['809', '829', '849']],
    ...
    ['Fiji', 'Фиджи', 'fj', '679'],
    ['Finland', 'Финляндия', 'fi', '358', 0],
    ['France', 'Франция', 'fr', '33'],
    ['French Guiana', 'Гвиана Французская', 'gf', '594'],
    ['French Polynesia', 'Полинезия Французская', 'pf', '689'],
    ['Gabon', 'Габон', 'ga', '241'],
    ...
    ['Guadeloupe', 'Гваделупа', 'gp', '590', 0],
    ['Guam', 'Гуам', 'gu', '1671'],
    ['Guatemala', 'Гватемала', 'gt', '502'],
    ['Guernsey', 'Гернси', 'gg', '44', 1],
    ...
    ['Niue', 'Ниуэ', 'nu', '683'],
    ['Norfolk Island', 'Остров Норфолк', 'nf', '672'],
    ['North Korea', 'Северная Корея', 'kp', '850'],
    ['Northern Mariana Islands', 'Северные Марианские Острова', 'mp', '1670'],
    ['Norway', 'Норвегия', 'no', '47', 0],
    ['Oman', 'Оман', 'om', '968'],
    ...
    ['Svalbard and Jan Mayen', 'Шпицберген и Ян-Майен', 'sj', '47', 1],
    ...
    ['Timor-Leste', 'Восточный Тимор', 'tl', '670'],
    ['Togo', 'Того', 'tg', '228'],
...
export const getCountriesMap = (countries = defaultCountriesData) =>
