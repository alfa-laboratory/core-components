...
```tsx live
<>
    <Typography.TitleMobile>Мобильный заголовок для шрифта styrene</Typography.TitleMobile>
    <Typography.TitleMobile font='system'>
        Мобильный заголовок для шрифта system
    </Typography.TitleMobile>
</>
```
