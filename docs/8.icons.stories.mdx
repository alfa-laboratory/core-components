...
- CDN с иконками: `alfabank.gcdn.co/icons/` + название иконки (например, https://alfabank.gcdn.co/icons/glyph_star_m.svg)
...
Проверьте, что `alfabank.gcdn.co` добавлен в список разрешённых источников:

<p style={{marginBottom: 8}}><code>'img-src': `'self' click.alfabank.ru alfabank.gcdn.co data: 'self'`</code></p>
